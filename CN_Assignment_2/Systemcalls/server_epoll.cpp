...
int main()
{
    ...
    cout << "Server(epoll()) intialised..." << endl;
    ...
    while (true)
    {
        ...
        if (nfds == -1)
        {
            cerr << "Error waiting for epoll" << endl;
            return -1;
        }
        ...
        for (int i = 0; i < nfds; i++)
        {
            ...
            {
                int clientSocket = accept_conn(server_sock, "servepoll_log.txt");
                if (clientSocket == -1)
                {
                    return -1;
                }
                cout << "No client sock errors" << endl;
            ...
            else
            {
                ...
                handle_conn(clientSocket, "servepoll_log.txt");
            }
        }
    }
